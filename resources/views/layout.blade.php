        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link @yield('user')" aria-current="page" href="/user">
                                <i class="icon">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <li class="nav-item">
                            <a class="nav-link @yield('site')" aria-current="page" href="/site">
                                <i class="icon">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <li class="nav-item">
                            <a class="nav-link @yield('level')" aria-current="page" href="/level">
                                <i class="icon">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <span class="item-name">Level Approval</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @yield('form')" aria-current="page" href="/form">
                                ...
                                <span class="item-name">Form Setting</span>
                            </a>
                        </li>
                    @endif
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center show" href="#"
                                    id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="true">
                                    <img src="/assets/images/avatars/user.png" alt="User-Profile"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('signout') }}">Logout</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>

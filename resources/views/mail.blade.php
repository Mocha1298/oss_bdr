        ...
        <tbody>
            <tr>
                <td
                    ...
                    <a
                        ...
                        <img src="https://twc.id/wp-content/uploads/2021/11/Logo_TWC-IHM_2021-01-1.png" alt="Laravel Logo"
                            style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';max-width:100%;border:none;height:75px;max-height:75px;width:auto"
            ...
            <tr>
                <td width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <table class="m_1884485413773419270inner-body" align="center" width="570" cellpadding="0"
                            ...
                            <tr>
                                <td
                                    ...
                                    <h1
                                        ...
                                        Untuk Anda</h1>
                                    <p
                                        style="color:black;box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                        Anda mendapat notifikasi dari Borobudur OSS:</p>
                                    <p
                                    ...
                                    <p
                                        style="color:black;box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                        Regards,<br>
                                        Borobudur Online Single Submission</p>
            ...
            <tr>
                <td
                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                    <table class="m_1884485413773419270footer" align="center" width="570" cellpadding="0"
                        cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="center"
                                    ...
                                    <p
                                        ...
                                        © 2023 Borobudur OSS. All rights reserved.</p>
